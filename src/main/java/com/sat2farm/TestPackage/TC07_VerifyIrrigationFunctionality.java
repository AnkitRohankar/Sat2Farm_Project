...
public class TC07_VerifyIrrigationFunctionality extends TestBaseClass {
      ...
      @Test
      public void VerifyIrrigationFunctionality() throws InterruptedException, IOException
      {
		        ...
		        {  
		            ...
		            for (int j = 0; j < allFarm.size(); j++) {
		                ...
		                try {
		                    ...
		                    WebElement irrigationTable;
		                    try {

		      	                 irrigationTable = driver.findElement(By.xpath("//div[@id='irrigation_table']"));
		                        ...
		                        {
		                            System.out.println("Irrigation is not found");    
		                            System.out.println();
		                        }
