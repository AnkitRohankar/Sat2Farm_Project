...
public class TC06_VerifyLSWI_Functionality extends TestBaseClass  {

	

	@Test
	public void VerifyLSWI_Functionality() throws InterruptedException, IOException
	{
		        ...
		        {  
		            ...
		            for (int j = 0; j < allFarm.size(); j++) {
		                ...
		                try {
		                    ...
		                    WebElement lswiDate;
		                    try {
		                    	  lswiDate = driver.findElement(By.xpath("//b[@id='date2']"));
		                        ...
		                        {
		                            System.out.println("LSWI is not found");    
		                            System.out.println();
		                        }
