...
public class TC04_SoilMoisturefuctionality extends TestBaseClass {
	
	
	@Test
	public void SoilMoisturefuctionality() throws InterruptedException, IOException
	{
		        ...
		        {  
		            ...
		            for (int j = 0; j < allFarm.size(); j++) {
		                ...
		                try {
		                    ...
		                    WebElement soilMoistureDate;
		                    try {
		                    	  soilMoistureDate = driver.findElement(By.xpath("//b[@id='date']"));
		                        ...
		                        {
		                            System.out.println("Soil Moisture is not found");    
		                            System.out.println();
		                        }
